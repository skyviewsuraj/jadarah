            ...
            <div class="card mb-2">
                <div class="card-body">
                    <div class="d-flex mb-3">
                        <div class="flex-shrink-0 avatar-sm">
                            <div class="avatar-title bg-light rounded material-shadow">
                                <img src="<?php echo e(URL::asset('build/images/companies/img-6.png')); ?>" alt="" class="avatar-xxs" />
                            </div>
                        </div>
                        <div class="flex-grow-1 ms-3">
            ...
            <div class="card mb-2">
                <div class="card-body">
                    <div class="d-flex mb-3">
                        <div class="flex-shrink-0 avatar-sm">
                            <div class="avatar-title bg-light rounded material-shadow">
                                <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/vtc.svg')); ?>" alt="" class="avatar-xxs" />
                            </div>
                        </div>
                        <div class="flex-grow-1 ms-3">
            ...
            <div class="card mb-2">
                <div class="card-body">
                    <div class="d-flex mb-3">
                        <div class="flex-shrink-0 avatar-sm">
                            <div class="avatar-title bg-light rounded material-shadow">
                                <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/xsg.svg')); ?>" alt="" class="avatar-xxs" />
                            </div>
                        </div>
                        <div class="flex-grow-1 ms-3">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex mb-3">
                        <div class="flex-shrink-0 avatar-sm">
                            <div class="avatar-title bg-light rounded material-shadow">
                                <img src="<?php echo e(URL::asset('build/images/companies/img-8.png')); ?>" alt="" class="avatar-xxs" />
                            </div>
                        </div>
                        <div class="flex-grow-1 ms-3">
            ...
            <div class="card mb-2">
                <div class="card-body">
                    <div class="d-flex mb-3">
                        <div class="flex-shrink-0 avatar-sm">
                            <div class="avatar-title bg-light rounded material-shadow">
                                <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/bela.svg')); ?>" alt="" class="avatar-xxs" />
                            </div>
                        </div>
                        <div class="flex-grow-1 ms-3">
            ...
            <div class="card mb-2">
                <div class="card-body">
                    <div class="d-flex mb-3">
                        <div class="flex-shrink-0 avatar-sm">
                            <div class="avatar-title bg-light rounded material-shadow">
                                <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/arn.svg')); ?>" alt="" class="avatar-xxs" />
                            </div>
                        </div>
                        <div class="flex-grow-1 ms-3">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex mb-3">
                        <div class="flex-shrink-0 avatar-sm">
                            <div class="avatar-title bg-light rounded material-shadow">
                                <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/cs.svg')); ?>" alt="" class="avatar-xxs" />
                            </div>
                        </div>
                        <div class="flex-grow-1 ms-3">
            ...
            <div class="card mb-2">
                <div class="card-body">
                    <div class="d-flex mb-3">
                        <div class="flex-shrink-0 avatar-sm">
                            <div class="avatar-title bg-light rounded material-shadow">
                                <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/add.svg')); ?>" alt="" class="avatar-xxs" />
                            </div>
                        </div>
                        <div class="flex-grow-1 ms-3">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex mb-3">
                        <div class="flex-shrink-0 avatar-sm">
                            <div class="avatar-title bg-light rounded material-shadow">
                                <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/atm.svg')); ?>" alt="" class="avatar-xxs" />
                            </div>
                        </div>
                        <div class="flex-grow-1 ms-3">
            ...
            <div class="card mb-2 ribbon-box ribbon-fill right">
                ...
                <div class="card-body">
                    <div class="d-flex mb-3">
                        <div class="flex-shrink-0 avatar-sm">
                            <div class="avatar-title bg-light rounded material-shadow">
                                <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/bcbc.svg')); ?>" alt="" class="avatar-xxs" />
                            </div>
                        </div>
                        <div class="flex-grow-1 ms-3">
            ...
            <div class="card mb-2 ribbon-box ribbon-fill right">
                ...
                <div class="card-body">
                    <div class="d-flex mb-3">
                        <div class="flex-shrink-0 avatar-sm">
                            <div class="avatar-title bg-light rounded material-shadow">
                                <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/bix.svg')); ?>" alt="" class="avatar-xxs" />
                            </div>
                        </div>
                        <div class="flex-grow-1 ms-3">
            ...
            <div class="card mb-2 ribbon-box ribbon-fill right">
                ...
                <div class="card-body">
                    <div class="d-flex mb-3">
                        <div class="flex-shrink-0 avatar-sm">
                            <div class="avatar-title bg-light rounded material-shadow">
                                <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/rise.svg')); ?>" alt="" class="avatar-xxs" />
                            </div>
                        </div>
                        <div class="flex-grow-1 ms-3">
            ...
            <div class="card ribbon-box ribbon-fill right">
                ...
                <div class="card-body">
                    <div class="d-flex mb-3">
                        <div class="flex-shrink-0 avatar-sm">
                            <div class="avatar-title bg-light rounded material-shadow">
                                <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/ark.svg')); ?>" alt="" class="avatar-xxs" />
                            </div>
                        </div>
                        <div class="flex-grow-1 ms-3">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\laraveljadrah\resources\views/apps-crypto-ico.blade.php ENDPATH**/ ?>