                        ...
                        <div class="card-header">
                            <div class="row g-4">
                                <div class="col-sm-auto">
                                    <div>
                                        <h5 class="card-title"> <?php echo e(__("Instructors")); ?></h5>
                                    </div>
                                </div>
                                <div class="col-sm">
                                    ...
                                    <table class="table table-borderd responsive" style="width: 100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><?php echo e(__("Instructor Details")); ?></th>
                                        ...
                                        <tbody>
                                            <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="badge bg-primary"><?php echo e($user->instructorDetails?->specialty); ?></span>
                                                    </td>
                                                    <td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\laraveljadrah\resources\views/users/instructors.blade.php ENDPATH**/ ?>