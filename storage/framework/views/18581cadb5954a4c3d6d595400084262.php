                    ...
                    <div class="text-center">
                        ...
                        <div class="row justify-content-center mt-5 mb-2">
                            <div class="col-sm-7 col-8">
                                <img src="<?php echo e(URL::asset('build/images/verification-img.png')); ?>" alt=""
                                    class="img-fluid" />
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="row text-center justify-content-center py-4">
                                    <div class="col-lg-11">
                                        ...
                                        <div class="hstack justify-content-center gap-2">
                                            <button type="button" class="btn btn-ghost-success material-shadow"
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(URL::asset('build/js/pages/crypto-kyc.init.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('build/js/app.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\laraveljadrah\resources\views/apps-crypto-kyc.blade.php ENDPATH**/ ?>