<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('translation.modals'); ?>
                        ...
                        <div class="modal fade" id="exampleModalPopovers" tabindex="-1" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <div class="mx-auto">
                                            <a href="javascript:void(0);" class="btn btn-link fw-medium material-shadow-none">Read More <i class="ri-arrow-right-line ms-1 align-middle"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="modal fade" id="exampleModalScrollable" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-scrollable">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-light material-shadow-none" data-bs-dismiss="modal">Close</button>
                                            <button type="button" class="btn btn-primary">Save changes</button>
                                        </div>
                                    </div><!-- /.modal-content -->
                                </div><!-- /.modal-dialog -->
                    ...
                    <div class="card text-center border">
                        <div class="card-body p-4 pb-0">
                            ...
                            <div class="row justify-content-center mt-2">
                                <div class="col-lg-10">
                                    <div>
                                        <img src="<?php echo e(URL::asset('build/images/modals/success-payment.png')); ?>" alt="Mac Image" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div><!-- end card body -->
                    ...
                    <div class="card text-center border">
                        <div class="card-body p-4 pb-0">
                            ...
                            <div class="row justify-content-center mt-2">
                                <div class="col-lg-10">
                                    <div>
                                        <img src="<?php echo e(URL::asset('build/images/modals/login.png')); ?>" alt="Mac Image" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div><!-- end card body -->
                    ...
                    <div class="card text-center border">
                        <div class="card-body p-4 pb-0">
                            ...
                            <div class="row justify-content-center mt-2">
                                <div class="col-lg-10">
                                    <div>
                                        <img src="<?php echo e(URL::asset('build/images/modals/subscribe.png')); ?>" alt="Mac Image" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div><!-- end card body -->
                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col-lg-5">
                                        <div class="subscribe-modals-cover h-100">
                                            <img src="<?php echo e(URL::asset('build/images/auth-one-bg.jpg')); ?>" alt="" class="h-100 w-100 object-fit-cover" style="clip-path: polygon(100% 0%, 100% 100%, 100% 100%, 0% 100%, 25% 50%, 0% 0%);">
                                        </div>
                                    </div>
                                </div>
                            </div><!-- /.modal-content -->
                    ...
                    <div class="card text-center border">
                        <div class="card-body p-4 pb-0">
                            ...
                            <div class="row justify-content-center mt-2">
                                <div class="col-lg-10">
                                    <div>
                                        <img src="<?php echo e(URL::asset('build/images/modals/signup.png')); ?>" alt="Mac Image" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div><!-- end card body -->
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\laraveljadrah\resources\views/ui-modals.blade.php ENDPATH**/ ?>