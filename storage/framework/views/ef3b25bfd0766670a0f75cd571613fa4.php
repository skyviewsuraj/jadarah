            ...
            <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('roles.index')); ?>">
                                    <?php echo app('translator')->get('Role and permissions'); ?>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('users.assign-role-form')); ?>">
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse menu-dropdown" id="sidebarCalendar">
                                    <ul class="nav nav-sm flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a href="apps-calendar-month-grid" class="nav-link"> <?php echo app('translator')->get('translation.month-grid'); ?>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                                    ...
                                    <ul class="nav nav-sm flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a href="charts-apex-range-area"
                                                class="nav-link"><span><?php echo app('translator')->get('translation.range-area'); ?></span> <span
                                                    class="badge badge-pill bg-success"><?php echo app('translator')->get('translation.new'); ?></span></a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="charts-apex-funnel"
                                                class="nav-link"><span><?php echo app('translator')->get('translation.funnel'); ?></span> <span
                                                    class="badge badge-pill bg-success"><?php echo app('translator')->get('translation.new'); ?></span></a>
                                        </li>
                                        <li class="nav-item">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarIcons">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="icons-remix" class="nav-link"><span><?php echo app('translator')->get('translation.remix'); ?></span><span
...
<?php /**PATH C:\wamp64\www\laraveljadrah\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>