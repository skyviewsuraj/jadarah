...
<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('Edit a role'); ?>
                    ...
                    <div class="card-header">
                        <div class="row g-4">
                            <div class="col-sm-auto">
                                <div>
                                    <h5 class="card-title"> <?php echo e(__("Edit Role")); ?></h5>
                                </div>
                            </div>
                            <div class="col-sm">
                        ...
                        <div class="card-body">
                            <form action="<?php echo e(route('roles.update',$role->id)); ?>" method="POST" class="needs-validation" novalidate>
                                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="name" placeholder="<?php echo e(__('Enter role name')); ?>" value="<?php echo e($role->name); ?>" required autofocus>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <?php $__empty_1 = true; $__currentLoopData = $group; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                        ...
                                                        <label>
                                                            <input <?php echo e($role->permissions->contains('id',$permission->id) ? "checked" : ""); ?> name="permissions[]" class="permissioncheckbox" type="checkbox" value="<?php echo e($permission->name); ?>">
...
<script src="<?php echo e(url('build/js/checkbox.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('build/js/checkbox.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\laraveljadrah\resources\views/roles/edit.blade.php ENDPATH**/ ?>