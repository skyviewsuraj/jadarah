...
<?php $__env->startSection('content'); ?>
    ...
    <div class="pt-4 mb-4 mb-lg-3 pb-lg-4 profile-wrapper">
        <div class="row g-4">
            <div class="col-auto">
                <div class="avatar-lg">
                    <img src="<?php echo e(URL::asset('build/images/users/avatar-1.jpg')); ?>" alt="user-img" class="img-thumbnail rounded-circle" />
                </div>
            </div>
            <!--end col-->
            <div class="col">
                                        ...
                                        <div class="d-flex flex-wrap gap-2">
                                            <div>
                                                <a href="javascript:void(0);" class="avatar-xs d-block">
                                                    <span
                                                        class="avatar-title rounded-circle fs-16 bg-body text-body material-shadow">
                                            ...
                                            <div>
                                                <a href="javascript:void(0);" class="avatar-xs d-block">
                                                    <span
                                                        class="avatar-title rounded-circle fs-16 bg-success material-shadow">
                                            ...
                                            <div>
                                                <a href="javascript:void(0);" class="avatar-xs d-block">
                                                    <span
                                                        class="avatar-title rounded-circle fs-16 bg-danger material-shadow">
                                        ...
                                        <div>
                                            <div class="d-flex align-items-center py-3">
                                                ...
                                                <div class="flex-shrink-0 ms-2">
                                                    <button type="button"
                                                        class="btn btn-sm btn-outline-success material-shadow-none"><i
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex mb-4">
                                            <div class="flex-shrink-0">
                                                <img src="<?php echo e(URL::asset('build/images/small/img-4.jpg')); ?>" alt="" height="50"
                                        ...
                                        <div class="d-flex mb-4">
                                            <div class="flex-shrink-0">
                                                <img src="<?php echo e(URL::asset('build/images/small/img-5.jpg')); ?>" alt="" height="50"
                                                    class="rounded material-shadow" />
                                            </div>
                                            <div class="flex-grow-1 ms-3 overflow-hidden">
                                                <a href="javascript:void(0);">
                                        ...
                                        <div class="d-flex">
                                            <div class="flex-shrink-0">
                                                <img src="<?php echo e(URL::asset('build/images/small/img-6.jpg')); ?>" alt="" height="50"
                                                    class="rounded material-shadow" />
                                            </div>
                                            <div class="flex-grow-1 ms-3 overflow-hidden">
                                                <a href="javascript:void(0);">
                                        ...
                                        <div class="swiper project-swiper mt-n4">
                                            ...
                                            <div class="swiper-wrapper">
                                                <div class="swiper-slide">
                                                    <div
                                                        class="card profile-project-card shadow-none profile-project-success mb-0 material-shadow">
                                                        <div class="card-body p-4">
                                                            <div class="d-flex">
                                                                <div class="flex-grow-1 text-muted overflow-hidden">
                                                                    <h5 class="fs-14 text-truncate mb-1">
                                                                        <a href="#" class="text-body">ABC Project
                                                                            Customization</a>
                                                                    </h5>
                                                ...
                                                <div class="swiper-slide">
                                                    <div
                                                        class="card profile-project-card shadow-none profile-project-danger mb-0 material-shadow">
                                                        <div class="card-body p-4">
                                                            <div class="d-flex">
                                                                <div class="flex-grow-1 text-muted overflow-hidden">
                                                                    <h5 class="fs-14 text-truncate mb-1">
                                                ...
                                                <div class="swiper-slide">
                                                    <div
                                                        class="card profile-project-card shadow-none profile-project-info mb-0 material-shadow">
                                                        <div class="card-body p-4">
                                                            <div class="d-flex">
                                                                <div class="flex-grow-1 text-muted overflow-hidden">
                                                                    <h5 class="fs-14 text-truncate mb-1">
                                                ...
                                                <div class="swiper-slide">
                                                    <div
                                                        class="card profile-project-card shadow-none profile-project-danger material-shadow mb-0">
                                                        <div class="card-body p-4">
                                                            <div class="d-flex">
                                                                <div class="flex-grow-1 text-muted overflow-hidden">
                                                                    <h5 class="fs-14 text-truncate mb-1">
                                                ...
                                                <div class="swiper-slide">
                                                    <div
                                                        class="card profile-project-card shadow-none profile-project-warning material-shadow mb-0">
                                                        <div class="card-body p-4">
                                                            <div class="d-flex">
                                                                <div class="flex-grow-1 text-muted overflow-hidden">
                                                                    <h5 class="fs-14 text-truncate mb-1">
                                        ...
                                        <div
                                            ...
                                            <div class="card-body p-4">
                                                <div class="d-flex">
                                                    ...
                                                    <div class="flex-shrink-0 ms-2">
                                                        <div class="badge bg-warning-subtle text-warning fs-10">Inprogress
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div
                                            ...
                                            <div class="card-body p-4">
                                                <div class="d-flex">
                                                    ...
                                                    <div class="flex-shrink-0 ms-2">
                                                        <div class="badge bg-primary-subtle text-primary fs-10"> Progress
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div
                                            ...
                                            <div class="card-body p-4">
                                                <div class="d-flex">
                                                    ...
                                                    <div class="flex-shrink-0 ms-2">
                                                        <div class="badge bg-success-subtle text-success fs-10">Completed
                                                        </div>
                                                    </div>
                                                </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\laraveljadrah\resources\views/pages-profile.blade.php ENDPATH**/ ?>