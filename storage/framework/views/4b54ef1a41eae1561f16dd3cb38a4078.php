                        ...
                        <div class="card-header">
                            <div class="row g-4">
                                <div class="col-sm-auto">
                                    <div>
                                        <h5 class="card-title"> <?php echo e(__("Batches")); ?></h5>
                                    </div>
                                </div>
                                <div class="col-sm">
                                    <div class="d-flex justify-content-sm-end">
                                        <div class="widgetbar">
                                            <a href="#" class="float-right btn btn-primary mr-2" data-bs-toggle="modal" data-bs-target="#batchModal"><i
                                                    class="feather icon-arrow-left mr-2"></i><?php echo e(__('Create New Batch')); ?></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                    ...
                                                    <td>
                                                        <div class="form-check form-switch" dir="ltr">
                                                            <input class="form-check-input" type="checkbox" role="switch"
                                                                ...
                                                                <?php echo e($batch->status === 1 ? 'checked' : ''); ?>>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex gap-2">
                                                            <a href="#"
                                                                ...
                                                                data-year-start="<?php echo e($batch->year_start); ?>"
                                                                data-year-end="<?php echo e($batch->year_end); ?>">
                                                                <i class="ri-pencil-fill"></i>
                                                            </a>
                                                            <form class="delete-form" action="<?php echo e(route('record.delete')); ?>" method="POST">
                                                                <?php echo csrf_field(); ?>
                                                                <?php echo method_field('DELETE'); ?>
                                                                <input type="hidden" name="model" value="Batch"> <input type="hidden" name="id" value="<?php echo e($batch->id); ?>"> <button type="button" class="btn btn-sm btn-danger delete-btn" data-model="Batch" data-id="<?php echo e($batch->id); ?>" data-name="<?php echo e($batch->year_start); ?> - <?php echo e($batch->year_end); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\laraveljadrah\resources\views/batches/index.blade.php ENDPATH**/ ?>