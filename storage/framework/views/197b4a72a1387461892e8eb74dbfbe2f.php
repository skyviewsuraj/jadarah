<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('translation.my-wallet'); ?>
                ...
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="toolbar d-flex align-items-start justify-content-center flex-wrap gap-2">
                            <button type="button" class="btn btn-soft-primary timeline-btn btn-sm material-shadow-none" id="one_month">
                                1M
                            </button>
                            <button type="button" class="btn btn-soft-primary timeline-btn btn-sm material-shadow-none" id="six_months">
                                6M
                            </button>
                            <button type="button" class="btn btn-soft-primary timeline-btn btn-sm material-shadow-none" id="one_year">
                                1Y
                            </button>
                            <button type="button" class="btn btn-soft-primary timeline-btn btn-sm material-shadow-none active" id="all">
                                ALL
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/btc.svg')); ?>" class="bg-light rounded-circle p-1 avatar-xs img-fluid" alt="">
                    ...
                    <div class="swiper-slide">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/ltc.svg')); ?>" class="bg-light rounded-circle p-1 avatar-xs img-fluid" alt="">
                    ...
                    <div class="swiper-slide">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/eth.svg')); ?>" class="bg-light rounded-circle p-1 avatar-xs img-fluid material-shadow" alt="">
                    ...
                    <div class="swiper-slide">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/xmr.svg')); ?>" class="bg-light rounded-circle p-1 avatar-xs img-fluid material-shadow" alt="">
                    ...
                    <div class="swiper-slide">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/mkr.svg')); ?>" class="bg-light rounded-circle p-1 avatar-xs img-fluid material-shadow" alt="">
                    ...
                    <div class="swiper-slide">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/neo.svg')); ?>" class="bg-light rounded-circle p-1 avatar-xs img-fluid material-shadow" alt="">
                        ...
                        <table class="table align-middle table-nowrap" id="customerTable">
                            ...
                            <tbody class="list form-check-all">
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center fw-medium">
                                            <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/btc.svg')); ?>" alt="" class="avatar-xxs me-2 material-shadow" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center fw-medium">
                                            <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/eth.svg')); ?>" alt="" class="avatar-xxs me-2 material-shadow" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center fw-medium">
                                            <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/xrp.svg')); ?>" alt="" class="avatar-xxs me-2 material-shadow" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center fw-medium">
                                            <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/xmr.svg')); ?>" alt="" class="avatar-xxs me-2 material-shadow" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center fw-medium">
                                            <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/ltc.svg')); ?>" alt="" class="avatar-xxs me-2 material-shadow" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center fw-medium">
                                            <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/aave.svg')); ?>" alt="" class="avatar-xxs me-2 material-shadow" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center fw-medium">
                                            <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/mkr.svg')); ?>" alt="" class="avatar-xxs me-2 material-shadow" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center fw-medium">
                                            <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/yfi.svg')); ?>" alt="" class="avatar-xxs me-2 material-shadow" />
        ...
        <div class="col-xxl-3">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex mb-3">
                        <div class="flex-shrink-0">
                            <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/xmr.svg')); ?>" alt="" class="avatar-xxs material-shadow" />
                        </div>
                        <div class="flex-grow-1 ms-3">
                    ...
                    <div class="d-flex mb-3">
                        <div class="flex-shrink-0">
                            <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/fil.svg')); ?>" alt="" class="avatar-xxs material-shadow" />
                        </div>
                        <div class="flex-grow-1 ms-3">
                    ...
                    <div class="d-flex mb-3">
                        <div class="flex-shrink-0">
                            <img src="<?php echo e(URL::asset('build/images/svg/crypto-icons/dot.svg')); ?>" alt="" class="avatar-xxs material-shadow" />
                        </div>
                        <div class="flex-grow-1 ms-3">
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(URL::asset('build/js/pages/crypto-wallet.init.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('build/js/app.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\laraveljadrah\resources\views/apps-crypto-wallet.blade.php ENDPATH**/ ?>